...
session_start();
include('../user_controller/network_form.php');
...
if(isset($_POST['network_submit']))
{
    ...
    $run = network_form($fname,$mname,$lname,$mother_name,$email,$birth_date,$age,$address,$city,$pin_code,$state,$ssc,$hsc,$Hq,$skills,$work_exp,$exp,$company,$department,$position);
