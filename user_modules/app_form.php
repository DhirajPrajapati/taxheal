...
session_start();
include('../user_controller/app_form.php');
...
if(isset($_POST['app_submit']))
{
    ...
    $run = app_form($fname,$mname,$lname,$mother_name,$email,$birth_date,$age,$address,$city,$pin_code,$state,$ssc,$hsc,$Hq,$skills,$work_exp,$exp,$company,$department,$position);
