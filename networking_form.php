    ...
    <div class="web-overlay">
        <div class="container">
            <div class="web-details">
                <h1 class="text-center text-white">APPLICATION FOR APP DEVELOPMENT</h1>
                <form action="./user_modules/network_form.php" method="POST" class="layout">
                    <div class="row">
                    ...
                    <button class="btn btn-primary" type="submit" name="network_submit">Submit</button>
                </form>
            </div>
        </div>
    </div>
